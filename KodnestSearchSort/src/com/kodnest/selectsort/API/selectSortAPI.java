	...
	public static void main(String[] args) 
	{
		...
		case 1:
		{
			...
			case 1:
			{
				...
				new linearSearch();
				int res=linearSearch.linearSearching(arr, key);
				if(res>=0)
				{
			...
			case 2:
			{
				...
				int key=scan.nextInt();
				new binarySearch();
				int res=binarySearch.binarySearching(arr, key);
				if(res>=0)
				{
					System.out.println("Key Fount at Index "+res);
				}
		...
		case 2:
		{
			...
			case 1:
			{
				...
				case 1:
				{
					...
					bubbleSortAsc asc=new bubbleSortAsc();
				...
				case 2:
				{
					...
					bubbleSortDsc dsc=new bubbleSortDsc();
			...
			case 2:
			{
				...
				case 1:
				{
					...
					selectionSortAsc asc=new selectionSortAsc();
				...
				case 2:
				{
					...
					selectionSortDsc dsc=new selectionSortDsc();
			...
			case 3:
			{
				...
				case 1:
				{
					...
					insertionSortAsc asc=new insertionSortAsc();
				...
				case 2:
				{
					...
					insertionSortDsc dsc=new insertionSortDsc();
		...
		case 3:
		{
			int res=findMinimum.findMin(arr);
			System.out.println("The Minimum Element is "+res);
			break;
		}
		case 4:
		{
			int res=findMaximum.findMax(arr);
